...
import java.io.*;
	...
	public class Graph_M 
	{
		...
		{
			g.addVertex("Uttra North");
			g.addVertex("Uttra center");
			g.addVertex("Uttra South");
			g.addVertex("Pallabi");
			g.addVertex("Mirpur-11");
			g.addVertex("Mirpur-10");
			g.addVertex("Kazipara");
			g.addVertex("Shewrapara");
			g.addVertex("Agargone");
			g.addVertex("Bijoy Sarani");
			g.addVertex("Karean Bazar");
			g.addVertex("Shahvagh");
			g.addVertex("Dhaka University");
			g.addVertex("Scretariat");
			g.addVertex("Matijheel");
			g.addVertex("Kamalapur");
			g.addVertex("Rajarbagh");
			g.addVertex("Malibagh");
			g.addVertex("Rampura");
			g.addVertex("Hatir jheel");
                        g.addVertex("Badda");
                        g.addVertex("Notun Bazar");
                        g.addVertex("Future Park");
                        g.addVertex("Khilkhet");
                        g.addVertex("Arrport");
                        g.addVertex("Bashundhara");
                        g.addVertex("Mastul");
			g.addVertex("Purbachal");
                         
                         
                         
            ////////////////////////////////////////////////////////////////////// /////////////
			g.addEdge("Uttra North", "Uttra center", 1);
			g.addEdge("Uttra center", "Uttra South", 2);
			g.addEdge("Uttra South", "Pallabi", 2);
			g.addEdge("Pallabi", "Mirpur-11", 1);
			g.addEdge("Mirpur-11", "Mirpur-10", 1);
			g.addEdge("Mirpur-10", "Kazipara", 2);
			g.addEdge("Kazipara", "Shewrapara", 2);
			g.addEdge("Shewrapara", "Agargone", 2);
			g.addEdge("Agargone", "Bijoy Sarani", 2);
			g.addEdge("Bijoy Sarani", "Karean Bazar", 2);
			g.addEdge("Karean Bazar", "Shahvagh", 1);
			g.addEdge("Shahvagh", "Dhaka University", 2);
			g.addEdge("Dhaka University", "Scretariat", 1);
			g.addEdge("Scretariat", "Matijheel", 2);
			g.addEdge("Matijheel", "Kamalapur", 2);
			g.addEdge("Kamalapur", "Rajarbagh", 3);
			g.addEdge("Rajarbagh", "Malibagh", 2);
			g.addEdge("Malibagh", "Rampura", 2);
			g.addEdge("Rampura", "Hatir jheel", 3);
                        g.addEdge("Hatir jheel", "Badda", 3);
                        g.addEdge("Badda", "Notun Bazar", 2);
                        g.addEdge("Notun Bazar", "Future Park", 2);
                        g.addEdge("Future Park", "Bashundhara", 2);
                        g.addEdge("Bashundhara", "Mastul", 2);
                        g.addEdge("Mastul", "Purbachal", 2);
                        g.addEdge("Future Park", "Khilkhet", 2);
                        g.addEdge("Khilkhet", "Arrport", 2);
                        g.addEdge("Arrport", "Uttra center", 2);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			System.out.println("\n\t\t\t****WELCOME TO THE DHAKA METRO APP*****");
